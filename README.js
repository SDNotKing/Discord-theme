//META{"name":"ShowHiddenChannels","website":"https://github.com/mwittrien/BetterDiscordAddons/tree/master/Plugins/ShowHiddenChannels","source":"https://raw.githubusercontent.com/SDNotKing/Discord-theme/master/README.js"}*//
...
class ShowHiddenChannels {
	...
	initConstructor () {
		...
		this.defaults = {
			settings: {
				showText:				{value:true, 	inner:true,	description:"Show hidden Textchannels:"},
				showVoice:				{value:true, 	inner:true,	description:"Show hidden Voicechannels:"},
				showNews:				{value:true, 	inner:true,	description:"Show hidden Newschannels:"},
				showStore:				{value:true, 	inner:true,	description:"Show hidden Storechannels:"},
				showCategory:			{value:true, 	inner:true,	description:"Show hidden Categories:"},
				showForNormal:			{value:true,	inner:true,	description:"Also show Roles/Users for visible Channels on hover:"},
				...
				showTopic:				{value:true, 	inner:true,		description:"The Topic of the Channel (only for hidden):"},
				showChannelCategory:	{value:true, 	inner:true,		description:"The Category of the Channel (only for hidden):"},
				showVoiceUsers:			{value:true, 	inner:true,		description:"All currently connected Users of a Voice Channel (only for hidden/locked):"}
			},
			amounts: {
